...
public class TopazEventSet implements EventSet {
	private static Logger logger = LoggerFactory.getLogger( TopazEventSet.class.getName() );
	...
	public static void main( String[] args ) {
		TopazEventSet es = new TopazEventSet();
